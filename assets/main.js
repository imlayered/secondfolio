...
function dragElement(elmnt) {
  ...
  if (document.getElementById(elmnt.id + "windowButtons")) {
    // if present, the windowButtons is where you move the DIV from:
    document.getElementById(elmnt.id + "windowButtons").onmousedown = dragMouseDown;
  } else {
